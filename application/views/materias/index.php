            ...
            <tbody>
                <?php foreach($records as $item) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?=site_url('Materias_controller/modificar/'.$item->idmateria)?>">Modificar</a>
                            <a href="<?=site_url('Materias_controller/eliminar/'.$item->idmateria)?>" onclick="return confirm('¿Está seguro?')">Eliminar</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
