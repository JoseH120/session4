            ...
            <tbody>
                <?php foreach($records as $item) : ?>
                    <tr>
                        ...
                        <td><?php echo $item->profesor ?></td>
                        <td>
                            <a href="<?=site_url('Grupos_controller/modificar/'.$item->idgrupo)?>">Modificar</a>                  
                            <a href="<?=site_url('Grupos_controller/eliminar/'.$item->idgrupo)?>" onclick="return confirm('¿Esta seguro?')">Eliminar</a>          
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
